...
@Templated
@Page(path = "datatable")
public class DataTablePage extends AbstractPage {
    ...
    public String getDescription() {
        return "Data tables display sets of raw data. They usually appear in desktop enterprise products. " +
               "Material DataTable supports Standard, Infinite Table, Pager and Context Menu.";
    }
