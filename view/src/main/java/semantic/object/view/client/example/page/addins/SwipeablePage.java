...
@Templated
@Page(path = "swipeable")
public class SwipeablePage extends AbstractPage {
    ...
    public String getDescription() {
        return "A panel that allows any of its nested children to be swiped away. " +
               "This component is only applicable to touch screen devices.";
    }
